    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fa-solid fa-box me-2"></i>Tambah Data Barang Keluar
            </h5>
        </div>
        <div class="card-body">
            @if (session('error'))
            ...
            <!-- Bootstrap Tabs -->
            <ul class="nav nav-tabs" id="barangKeluarCreateTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="besi-s
                    crap-tab" data-bs-toggle="tab"
                        data-bs-target="#besi-scrap-form" type="button" role="tab" aria-controls="besi-scrap-form"
                        aria-selected="false">
            ...
            <div class="tab-content mt-4" id="barangKeluarCreateTabsContent">
                <!-- Besi Tua Form -->
                <div class="tab-pane fade show active" id="besi-tua-form" role="tabpanel" aria-labelledby="besi-tua-tab">
                    <form action="{{ route('barang-keluar.store') }}" method="POST" id="besi_tua_form">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    @endphp
                                    <span class="input-group-text">BK-BT-{{ $currentDate }}-</span>
                                ...
                                <div class="card bg-success text-white">
                                    <div class="card-header">
                                        <h6 class="card-title mb-0">
                                            <i class="fas fa-money-bill me-2"></i>Perhitungan Harga
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="jumlah_harga_besi_tua" class="form-label">Jumlah Harga
                                                    (Rp)</label>
                                                <input type="number" name="jumlah_harga" class="form-control"
                                                    id="jumlah_harga_besi_tua" value="{{ old('jumlah_harga') }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="tab-pane fade" id="besi-scrap-form" role="tabpanel" aria-labelledby="besi-scrap-tab">
                    <form action="{{ route('barang-keluar.store') }}" method="POST" id="besi_scrap_form">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="kode_besi_scrap" class="form-label">Kode <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">BK-BS-{{ $currentDate }}-</span>
                                ...
                                <div class="card bg-success text-white">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="jumlah_harga" class="form-label">Jumlah Harga (Rp)</label>
                                                <input type="number" name="jumlah_harga" class="form-control"
                                                    id="jumlah_harga" value="{{ old('jumlah_harga') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateNettoBesiTua() {
                ...
                $('#netto_besi_tua').val(netto > 0 ? netto.toFixed(2) : '0').trigger('change');
            }

            function updateJumlahHargaBesiTua() {
                let netto = parseFloat($('#netto_besi_tua').val()) || 0;
                let selectedProduct = $('#produk_id_besi_tua').find(':selected');
                let harga = selectedProduct.data('harga') || 0;
                let jumlahHarga = netto > 0 && harga > 0 ? netto * harga : 0;
                $('#jumlah_harga_besi_tua').val(jumlahHarga > 0 ? jumlahHarga.toFixed(2) : '0');
            }

            $('#bruto_besi_tua, #tara_besi_tua').on('input', updateNettoBesiTua);
            $('#netto_besi_tua').on('change', updateJumlahHargaBesiTua);
            $('#produk_id_besi_tua').on('change', updateJumlahHargaBesiTua);
            ...
            function updateNettoBersih() {
                ...
                $('#netto_bersih').val(nettoBersih > 0 ? nettoBersih.toFixed(2) : '0').trigger('change');
            }

            function updateJumlahHargaBesiScrap() {
                ...
                $('#jumlah_harga').val(jumlahHarga > 0 ? jumlahHarga.toFixed(2) : '0');
            }
            ...
            $('#harga').on('input', updateJumlahHargaBesiScrap);
            $('#netto_bersih').on('change', updateJumlahHargaBesiScrap);
