...
@section('content')
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        Stock Counts</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ count($stockCounts) }}</div>
                                </div>
                                <div class="col-auto">
    ...
    <script>
        ...
        @foreach ($ITRsInByMonth as $month => $counts)
            ITRSInmonthIndex = labels.indexOf('{{ $month }}');
