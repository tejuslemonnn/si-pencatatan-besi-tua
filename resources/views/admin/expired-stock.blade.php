...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Expired Stock</h1>
...
<table class="table">
    ...
    @endphp
            ...
            <tr>
                ...
                <td>
                    <a href= "/view-stock/{{ $row->id }}" class="btn btn-info">Detail</a> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('activeStock', ['id' => $row->id]) }}" method="post">
          @csrf
          @method('PUT')
