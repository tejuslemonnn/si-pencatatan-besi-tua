...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $productsBestSeller = Product::orderBy('terjual', 'desc')->limit(3)->get();
        $productsNonBestSeller = Product::orderBy('terjual', 'asc')->whereNotIn('id', $productsBestSeller->pluck('id'))->limit(3)->get();
